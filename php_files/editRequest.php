...
?>
    ...
    <input class="Botton resetBotton" type="submit" onclick="location.href ='../php_files/editingRequest.php?id=<?php echo($row[$id])?>'" value="Edit Job Request" style="left: 8px;"><br><br>
